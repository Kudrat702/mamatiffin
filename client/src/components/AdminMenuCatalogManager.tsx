          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (errors.priceWeekly) setErrors({ ...errors, priceWeekly: undefined });
              }}
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 ${
                errors.priceWeekly ? 'border-red-500' : 'border-gray-300'
              }`}
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-purple-600 mt-1">₹{selectedMenu.priceWeekly || 0}</p>
                </div>
                <div>
