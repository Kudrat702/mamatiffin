...
const Footer: React.FC = () => {
  return (
    <footer className="text-white py-8" style={{backgroundColor: 'rgb(50, 140, 129)'}}>
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <p className="text-white text-sm mb-4 md:mb-0">
            Copyright © 2025 | This website is made with ❤️ by mamatiffin
          </p>
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <div className="flex items-center space-x-3">
              {/* Facebook Icon */}
              <a
                href="https://www.facebook.com/profile.php?id=61580849124823"
                target="_blank"
              ...
              {/* Twitter/X Icon */}
              {/* <a
                href="https://twitter.com/mamatiffin"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full border-2 border-white/30 flex items-center justify-center text-white hover:bg-white hover:text-teal-600 transition-all duration-300 hover:scale-110"
                aria-label="Twitter"
              ...
              {/* Instagram Icon */}
              <a
                href="https://www.instagram.com/mamatiffin42/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full border-2 border-white/30 flex items-center justify-center text-white hover:bg-white hover:text-teal-600 transition-all duration-300 hover:scale-110"
              ...
              {/* LinkedIn Icon */}
              <a
                href="https://www.linkedin.com/company/mamatiffin"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full border-2 border-white/30 flex items-center justify-center text-white hover:bg-white hover:text-teal-600 transition-all duration-300 hover:scale-110"
                aria-label="LinkedIn"
