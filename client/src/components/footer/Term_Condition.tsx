  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-3xl font-bold text-gray-800 mb-8 text-center">Terms & Conditions</h1>
            ...
            <ol className="space-y-6">
              ...
              <li>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  <span className="font-semibold">mamatiffin.com</span> ('Website'), including the related mobile 
              ...
              <li>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  with the Platform Owner and these terms and conditions including the policies constitute Your 
                  binding obligations, with Platform Owner. These Terms of Use can be modified at any time without 
                  assigning any reason. It is your responsibility to periodically review these Terms of Use to stay 
                  informed of updates.
                </p>
              </li>
              ...
              <li>
                <p className="text-gray-700 leading-relaxed font-semibold uppercase">
              ...
              <li>
                ...
                <ol className="mt-4 space-y-4 pl-6">
                  <li className="text-gray-700 leading-relaxed">
                    ...
                    the use of your registered account on the Platform.
                  </li>
                  ...
                  <li className="text-gray-700 leading-relaxed">
                    ...
                    in its contents. The contents includes and is not limited to the design, layout, look and graphics.
                  </li>
                  ...
                  <li className="text-gray-700 leading-relaxed">
                    ...
                    their respective officers, directors, agents, and employees, from any claim or demand, or 
                    actions including reasonable attorney's fees, made by any third party or penalty imposed due 
                  ...
                  <li className="text-gray-700 leading-relaxed">
                    ...
                    jurisdiction of the courts in Hazaribagh and Jharkhand.
                  </li>
