// // AdminDashboard.tsx - COMPLETE UPDATED VERSION WITH LOCATION FIX
// // ✅ Fixed: Location delete now works with both _id and custom id
// // ✅ Fixed: Location edit handles missing custom id
// // ✅ Fixed: All validation and error handling improved
...
//   _id: string;
//   name: string;
//   id?: string;  // ✅ Make optional since existing data may not have it
//   createdAt?: string;
//   updatedAt?: string;
// }
...
//   // ✅ UPDATED: handleLocationSubmit with improved logic
...
//           id: locationFormData.id || undefined,  // ✅ Send only if provided
//         }),
//       });
...
//   // ✅ UPDATED: handleEditLocation with fallback
//   const handleEditLocation = (location: Location): void => {
//     console.log('✏️ Editing location:', location);
//     setEditingLocation(location);
//     setLocationFormData({
//       name: location.name,
//       id: location.id || '',  // ✅ Use empty string if no custom id
//     });
//     setShowLocationForm(true);
//   };

//   // ✅ UPDATED: handleDeleteLocation with better validation
...
//       alert('Invalid location selected. Please refresh the page and try again.');
//       return;
//     }
...
//           <p className="mb-4 text-gray-600">{locationsError}</p>
//           <button
...
//                 <div key={location._id} className="px-6 py-4 transition-colors hover:bg-gray-50">
//                   <div className="flex items-center justify-between">
...
//                         Edit
//                       </button>
//                       {/* ✅ FIXED: Delete button with proper ID handling */}
//                       <button
//                         onClick={() => {
//                           console.log('🔍 Delete button clicked for location:', {
//                             _id: location._id,
//                             id: location.id,
//                             name: location.name
//                           });
//                           // ✅ Use custom id if available, otherwise use _id
//                           const locationIdentifier = location.id || location._id;
//                           handleDeleteLocation(locationIdentifier);
//                         }}
...
//               <div className="mb-2 text-4xl font-bold text-emerald-600">{locations.length}</div>
...
// client/src/components/AdminDashboard.tsx - COMPLETE VERSION
// ✅ Location logic separated into AdminLocation.tsx
// ✅ All other functionalities intact
...
import AdminMessagesDashboard from './AdminMessagesDashboard';
import UsersList from './UsersList';
import AdminLocation from './AdminLocation';  // ✅ Location Component Import
import { apiEndpoints } from '../configapi/api';
import { type Menu } from '../types/menu';
import {
  LayoutDashboard,
