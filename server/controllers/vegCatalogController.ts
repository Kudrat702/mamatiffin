// // ===== FILE: controllers/vegCatalogController.ts (UPDATED) =====
...
//       if (deleted) {
//         console.log('Old veg catalog image successfully deleted:', oldImageUrl);
//       }
//     }
//   } catch (error) {
...
// export const getVegCatalog = async (req: Request, res: Response): Promise<void> => {
//   try {
//     const vegItems = await CatalogItem.find({ type: 'veg' })
...
//     res.status(500).json({
//       success: false,
//       message: 'Error fetching veg catalog items',
//       error: error instanceof Error ? error.message : 'Unknown error'
//     });
//   }
// };

// export const getVegCatalogByCategory = async (req: Request, res: Response): Promise<void> => {
//   try {
//     const { category } = req.params;
    
//     const vegItems = await CatalogItem.find({ 
//       type: 'veg', 
//       category: category 
//     })
//     .populate('menuDetailId', 'title description deliveryTime priceTrial weeklyMenu')
...
//     res.status(500).json({
//       success: false,
//       message: 'Error fetching veg catalog items by category',
//       error: error instanceof Error ? error.message : 'Unknown error'
//     });
//   }
// };

// export const createVegCatalogItem = async (req: Request, res: Response): Promise<void> => {
//   try {
...
//     const existingItem = await CatalogItem.findOne({ category, type: 'veg' });
//     if (existingItem) {
//       res.status(409).json({
//         success: false,
//         message: 'Veg catalog item with this category already exists'
//       });
//       return;
//     }
...
//     console.log('New veg catalog item created:', {
//       id: savedItem._id,
...
//       success: true,
//       data: savedItem,
//       message: 'Veg catalog item created successfully'
//     });
//   } catch (error) {
//     console.error('Error creating veg catalog item:', error);
//     res.status(500).json({
//       success: false,
//       message: 'Error creating veg catalog item',
//       error: error instanceof Error ? error.message : 'Unknown error'
//     });
//   }
// };

// export const updateVegCatalogItem = async (req: Request, res: Response): Promise<void> => {
//   try {
//     const { id } = req.params;
//     const { category, imageUrl, price, menuDetailId } = req.body;
...
//     const existingItem = await CatalogItem.findOne({ _id: id, type: 'veg' });
//     if (!existingItem) {
//       res.status(404).json({
//         success: false,
...
//     console.log('Veg catalog item updated:', {
//       id: updatedItem?._id,
...
//       success: true,
//       data: updatedItem,
//       message: 'Veg catalog item updated successfully'
//     });
//   } catch (error) {
//     console.error('Error updating veg catalog item:', error);
//     res.status(500).json({
//       success: false,
//       message: 'Error updating veg catalog item',
//       error: error instanceof Error ? error.message : 'Unknown error'
//     });
//   }
// };

// export const deleteVegCatalogItem = async (req: Request, res: Response): Promise<void> => {
//   try {
//     const { id } = req.params;

//     // Find item first to get image URL for cleanup
//     const itemToDelete = await CatalogItem.findOne({ _id: id, type: 'veg' });
//     if (!itemToDelete) {
//       res.status(404).json({
//         success: false,
//         message: 'Veg catalog item not found'
...
//       if (deleted) {
//         console.log('Associated image deleted for veg catalog item:', id);
//       }
//     }
...
//     const deletedItem = await CatalogItem.findOneAndDelete({ _id: id, type: 'veg' });

//     console.log('Veg catalog item deleted:', {
//       id: deletedItem?._id,
...
//       success: true,
//       data: deletedItem,
//       message: 'Veg catalog item deleted successfully'
//     });
//   } catch (error) {
//     console.error('Error deleting veg catalog item:', error);
//     res.status(500).json({
//       success: false,
//       message: 'Error deleting veg catalog item',
//       error: error instanceof Error ? error.message : 'Unknown error'
//     });
//   }
// };

// controllers/vegCatalogController.ts - CLOUDINARY INTEGRATED
import { Request, Response } from 'express';
import CatalogItem from '../models/catalogItem';
  ...
  try {
    if (oldImageUrl !== newImageUrl) {
      if (useCloudinary && oldImagePublicId) {
        ...
        console.log('Old veg catalog image deleted from Cloudinary:', oldImagePublicId);
      }
    }
  } catch (error) {
    console.error('Error handling image update:', error);
  ...
  try {
    ...
    if (itemToDelete.imageUrl) {
      if (useCloudinary && itemToDelete.imagePublicId) {
        ...
        console.log('Cloudinary image deleted for veg catalog item:', id);
      }
    }
