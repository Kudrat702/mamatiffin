 ...
 * GET /api/menus/admin/menu-details?category=veg&menuType=breakfast&page=1&limit=10
 */
router.get(
  '/admin/menu-details',
...
router.post(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      // ✅ priceWeekly bhi log mein add kiya — confirm karne ke liye ki value aa rahi hai
      console.log('✅ Processed request:', {
        category: req.body.category,
        menuType: req.body.menuType,
        title: req.body.title,
        priceMonthly: req.body.priceMonthly,
        priceWeekly: req.body.priceWeekly,   // ✅ ADDED
 ...
 * GET /api/menus/veg-menus
 * GET /api/menus/non-veg-menus
 */
 ...
 * POST /api/menus/veg-menu-details
 * POST /api/menus/non-veg-menu-details
 */
router.post(
  '/veg-menu-details',
  uploadMenu.single('image'),
...
/**
 * DELETE ENDPOINT
 * DELETE /api/menus/admin/:category/:menuType
 */
router.delete(
...
router.use((req: Request, res: Response): void => {
  res.status(404).json({
    ...
    availableEndpoints: [
      'GET /api/menus/health',
      'GET /api/menus/:diet/:category',
      'GET /api/menus/admin/menu-details',
      'GET /api/menus/veg-menus',
      'GET /api/menus/non-veg-menus',
      'POST /api/menus/admin/menu',
      'POST /api/menus/veg-menu-details',
